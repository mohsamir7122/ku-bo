...
- `SourceNetworkCatalog`: يقرأ 69 تعريف مصدر و63 مجموعة استقلال وسياسات الأفق، ويتحقق من الأدوار والنطاقات والاستقلال وحدود التوقيت. يوجد 60 نطاقًا مرشحًا بعد استبعاد البحث والتخزين، و54 نطاقًا معلنًا Enabled-public، و53 نطاق Start URL تنفيذيًا مميزًا قبل الحجز. العدد لا يساوي تأكيدات مستقلة.
...
الكتالوج لا يساوي طبقة جمع حية: الحالة الحالية 67 `DEFINED_ONLY` و2 `END_TO_END_TESTED` على Fixtures مولدة و0 `LIVE_OPERATIONAL`.
