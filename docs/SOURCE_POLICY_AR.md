...
لا يشترط نجاح بورصة الكويت كي يبدأ Research Rank. إذا تعذرت، سجل الفشل واستكمل النصاب من مصادر مستقلة. لا تنقل صفة «رسمي» إلى مصدر بديل؛ اجعل `official_confirmation_available = false` وخفّض المحفز الاتجاهي إلى `WATCH`.
