...
الكتالوج على الفرع يحتوي 71 تعريف مصدر و65 مجموعة استقلال و61 نطاقًا مرشحًا
بعد استبعاد البحث والتخزين. منها 54 نطاقًا معلنًا Enabled-public، و53 نطاق
...
Router مسجل وغير منفذ. حالة القدرة: 69 `DEFINED_ONLY`، و2
