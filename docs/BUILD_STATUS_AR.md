...
- كتالوج يحوي 71 تعريف مصدر موزعة على 65 مجموعة استقلال و61 نطاقًا مرشحًا بعد استبعاد البحث والتخزين؛ 54 منها معلنة Enabled-public في الكتالوج، و53 نطاق Start URL عامًا مميزًا قبل الحجز. هذه تعريفات سياسة وليست موصلات حية.
